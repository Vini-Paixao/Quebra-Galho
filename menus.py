...
from utilidades import abrir_url, resource_path, open_tela
...
def menu_principal():
    ...
    btn_limpar_formatacao = tk.Button(
        janela, 
    ...
    def on_closing():
        if messagebox.askokcancel("Sair", "Você tem certeza que deseja fechar o programa?"):
            janela.destroy()

    # Associa a função de fechamento à janela principal
...
def menu_sql():
    ...
    # Botões do menu SQL
    btn_validador_sintaxe = tk.Button(
        frame_1, 
    ...
    btn_formatacao_consultas = tk.Button(
        frame_2, 
